...
reviews_by_title = {
  '機動戦士ガンダム' => [
    ...
    { user: '中村 拓也', rating: 5, status: 'watched',
      comment: '入門として少し身構えていましたが、想像よりもドラマとして見やすかったです。キャラクターの未熟さが丁寧に描かれていました。' }
  ],
  'Zガンダム' => [
  ...
  '水星の魔女' => [
    ...
    { user: '高橋 莉子', rating: 5, status: 'watched',
      comment: 'キャラクターの表情や会話のテンポが自然で、初回から引き込まれました。初めてのガンダムとしても選びやすいと思います。' },
    { user: '小林 みなみ', rating: 4, status: 'watched',
      comment: '明るい入り口と緊張感のある展開の差が印象的でした。話数も追いやすく、スクリーンショット映えする作品だと思います。' },
  ...
  '逆襲のシャア' => [
    ...
    { user: '中村 拓也', rating: 5, status: 'watched',
      comment: '映像や音楽の雰囲気が印象的で、見終わったあとにしばらく余韻が残りました。シリーズの節目として強い作品だと思います。' },
  ...
  'ガンダム00' => [
    ...
    { user: '高橋 莉子', rating: 4, status: 'watched',
      comment: 'スタイリッシュでテンポがよく、初めて見るシリーズとしても選びやすいと思います。キャラクターの目的が追いやすいです。' },
